...
var Particles = function (window, document) {
  ...
  Plugin.prototype._initializeCanvas = function () {
    ...
    backingStoreRatio = _.context.webkitBackingStorePixelRatio || _.context.mozBackingStorePixelRatio || _.context.msBackingStorePixelRatio || _.context.oBackingStorePixelRatio || _.context.backingStorePixelRatio || 1;
  ...
  Plugin.prototype._registerBreakpoints = function () {
    ...
    if ((typeof responsiveSettings === 'undefined' ? 'undefined' : _typeof(responsiveSettings)) === 'object' && responsiveSettings !== null && responsiveSettings.length) {
   ...
   */
  Particle = function Particle(context, options) {
    var _ = this,
        random = Math.random,
        speed = options.speed,
